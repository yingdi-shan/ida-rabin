...
{
	memcpy(out, in, sizeof(encode_t) * 8 * width);
}
...
static void gf8_muladd_01(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		XOR3(out_ptr[0],out_ptr[0],in_ptr[0]);
		XOR3(out_ptr[width],out_ptr[width],in_ptr[width]);
		XOR3(out_ptr[width * 2],out_ptr[width * 2],in_ptr[width * 2]);
		XOR3(out_ptr[width * 3],out_ptr[width * 3],in_ptr[width * 3]);
		XOR3(out_ptr[width * 4],out_ptr[width * 4],in_ptr[width * 4]);
		XOR3(out_ptr[width * 5],out_ptr[width * 5],in_ptr[width * 5]);
		XOR3(out_ptr[width * 6],out_ptr[width * 6],in_ptr[width * 6]);
		XOR3(out_ptr[width * 7],out_ptr[width * 7],in_ptr[width * 7]);
		in_ptr++;
		out_ptr++;
	}
}
...
static void gf8_muladd_02(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		encode_t out0, out1, out2, out3, out4, out5, out6, out7;

		encode_t in0 = out_ptr[0];
		encode_t in1 = out_ptr[width];
		encode_t in2 = out_ptr[width * 2];
		encode_t in3 = out_ptr[width * 3];
		encode_t in4 = out_ptr[width * 4];
		encode_t in5 = out_ptr[width * 5];
		encode_t in6 = out_ptr[width * 6];
		encode_t in7 = out_ptr[width * 7];
		...
		XOR3(out_ptr[0],out0,in_ptr[0]);
		XOR3(out_ptr[width],out1,in_ptr[width]);
		XOR3(out_ptr[width * 2],out2,in_ptr[width * 2]);
		XOR3(out_ptr[width * 3],out3,in_ptr[width * 3]);
		XOR3(out_ptr[width * 4],out4,in_ptr[width * 4]);
		XOR3(out_ptr[width * 5],out5,in_ptr[width * 5]);
		XOR3(out_ptr[width * 6],out6,in_ptr[width * 6]);
		XOR3(out_ptr[width * 7],out7,in_ptr[width * 7]);
...
static void gf8_muladd_05(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out6,in4,in6);
		XOR3(out2,out0,in2);
		XOR4(out3,out1,in3,in6);
		XOR3(out5,out7,in3);
		XOR4(out4,out6,in2,in7);
...
static void gf8_muladd_06(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,in5,in6);
		XOR3(out6,in4,in5);
		XOR4(out4,in2,in3,in6);
		XOR4(out5,in3,in4,in7);
		XOR3(out3,tmp0,in2);
		XOR3(out2,tmp0,out1);
...
static void gf8_muladd_08(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out7 = in4;
		XOR3(out6,in3,in7);
		XOR4(out3,in0,in5,in6);
		XOR4(out5,in2,in6,in7);
		XOR3(out2,in5,in7);
		XOR4(out4,out2,in1,in6);
...
static void gf8_muladd_09(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in1,in6);
		XOR3(out7,in4,in7);
		XOR4(out2,in2,in5,in7);
		XOR3(out3,tmp0,out0);
		XOR3(out6,tmp0,in7);
		XOR4(out4,out1,out7,in5);
		XOR3(out5,out2,in6);
...
static void gf8_muladd_0A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in1,in5);
		XOR3(out6,out0,in3);
		XOR4(out3,out0,out1,in2);
		XOR4(out5,out7,in2,in7);
		XOR4(out4,out2,in3,in6);
...
static void gf8_muladd_0B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in0,in6);
		XOR3(tmp2,in4,in7);
		XOR4(out0,in0,in5,in7);
		XOR3(out2,tmp0,in1);
		XOR3(out1,tmp1,in1);
		XOR4(out6,tmp1,out0,in3);
		XOR3(out7,tmp2,in6);
		XOR4(out4,tmp2,out6,in1);
		XOR4(out3,out6,in0,in2);
		XOR3(out5,tmp0,out7);
...
static void gf8_muladd_0C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in1,in5);
		XOR3(tmp1,in0,in7);
		XOR4(out5,in2,in3,in6);
		XOR4(out6,in3,in4,in7);
		XOR3(out2,tmp1,out0);
		XOR3(out4,tmp0,in2);
		XOR3(out3,tmp0,tmp1);
...
static void gf8_muladd_0D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in5);
		XOR3(tmp1,in5,in6);
		XOR4(out1,in1,in6,in7);
		XOR3(out7,tmp0,in7);
		XOR4(out4,tmp0,in1,in2);
		XOR3(out0,tmp1,in0);
		XOR3(tmp2,tmp1,in3);
		XOR3(out6,tmp2,out7);
		XOR4(out2,out0,in2,in7);
		XOR4(out3,out0,out1,in3);
		XOR3(out5,tmp2,in2);
...
static void gf8_muladd_0E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in2,in5);
		XOR3(tmp2,in5,in6);
		XOR4(out1,in0,in6,in7);
		XOR3(out3,tmp0,tmp1);
		XOR3(out2,tmp0,tmp2);
		XOR3(tmp3,tmp1,in3);
		XOR3(out7,tmp2,in4);
		XOR3(out0,tmp2,in7);
		XOR4(out4,tmp3,in1,in7);
		XOR3(out5,tmp3,out7);
		XOR4(out6,out0,out5,in2);
...
static void gf8_muladd_0F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp2,in0);
		XOR3(out6,out7,in3);
		XOR4(out5,out6,in2,in7);
		XOR4(tmp3,tmp1,out0,in2);
		XOR3(out4,tmp1,out5);
		XOR3(out2,tmp3,in6);
		XOR3(out3,tmp3,in3);
...
static void gf8_muladd_11(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in1,in5);
		XOR3(out6,in2,in7);
		XOR4(out4,in0,in5,in6);
		XOR4(out5,in1,in6,in7);
		XOR4(out2,in2,in4,in6);
		XOR5(out3,in3,in4,in5,in7);
...
static void gf8_muladd_13(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in5);
		XOR3(tmp1,in4,in7);
		XOR4(out6,in2,in5,in7);
		XOR4(out4,tmp0,out7,in7);
		XOR3(out1,tmp0,in1);
		XOR3(out0,tmp1,in0);
		XOR4(out5,tmp1,in1,in6);
		XOR4(out3,tmp1,out6,in3);
		XOR3(out2,out5,in2);
...
static void gf8_muladd_15(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,in3,in5);
		XOR3(tmp0,in0,in4);
		XOR4(out1,in1,in5,in7);
		XOR4(out5,in1,in3,in6);
		XOR3(out0,tmp0,in6);
		XOR3(out2,tmp0,in2);
		XOR4(out3,out5,in4,in5);
		XOR4(out6,out2,in0,in7);
		XOR4(out4,tmp0,out6,in5);
...
static void gf8_muladd_16(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in5);
		XOR3(tmp1,in4,in7);
		XOR4(tmp2,in2,in3,in4);
		XOR3(out1,tmp0,in7);
		XOR3(out4,tmp0,tmp2);
		XOR3(out0,tmp1,in6);
		XOR3(tmp3,tmp1,in1);
		XOR4(out6,out0,in2,in5);
		XOR3(out2,tmp3,in0);
		XOR3(out3,out6,in1);
		XOR3(out7,tmp2,out6);
		XOR3(out5,tmp3,out7);
...
static void gf8_muladd_17(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in3,in6);
		XOR3(tmp2,tmp0,in4);
		XOR4(out4,tmp0,in0,in3);
		XOR3(out7,tmp1,in5);
		XOR3(tmp3,tmp1,in1);
		XOR3(out6,tmp2,in7);
		XOR3(out5,tmp3,in4);
		XOR3(out3,tmp3,out6);
		XOR4(out0,out3,out4,in1);
		XOR4(out2,out3,out7,in0);
		XOR3(out1,tmp2,out2);
...
static void gf8_muladd_18(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in5,in6);
		XOR3(tmp0,in4,in7);
		XOR4(out5,in1,in2,in5);
		XOR4(out6,in2,in3,in6);
		XOR3(out2,tmp0,out1);
		XOR3(out7,tmp0,in3);
		XOR3(tmp1,tmp0,in0);
		XOR3(out3,tmp1,in6);
...
static void gf8_muladd_19(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in7);
		XOR3(out6,in2,in3);
		XOR4(out1,in1,in5,in6);
		XOR4(out0,in0,in4,in5);
		XOR3(out4,tmp0,in1);
		XOR3(tmp1,tmp0,in6);
		XOR4(out2,tmp1,out0,in2);
		XOR3(out3,tmp1,out7);
...
static void gf8_muladd_1A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,tmp3,out0);
		XOR3(out6,tmp3,in2);
		XOR4(out4,tmp3,out2,in0);
		XOR4(out3,tmp0,out1,in2);
...
static void gf8_muladd_1B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	{
		encode_t out0, out1, out2, out3, out4, out5, out6, out7;
		encode_t tmp0, tmp1, tmp2, tmp3, tmp4;
...
static void gf8_muladd_1D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,tmp2,in5);
		XOR3(out2,tmp3,tmp4);
		XOR4(out4,out3,out6,in6);
		XOR3(out0,tmp4,in6);
		XOR4(out1,out2,out4,in4);
...
static void gf8_muladd_1E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp1,tmp2);
		XOR3(out2,tmp2,in5);
		XOR4(out4,out3,in3,in6);
		XOR3(tmp3,out4,in7);
		XOR4(out6,tmp3,out2,in4);
		XOR3(out7,tmp1,out6);
		XOR3(out0,out7,in3);
		XOR3(out1,tmp0,out0);
		XOR3(out5,tmp3,out1);
...
static void gf8_muladd_1F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,tmp0,in5);
		XOR3(out7,tmp1,in3);
		XOR4(out0,tmp1,in0,in7);
		XOR4(out6,out7,in2,in6);
		XOR4(out1,out0,in1,in4);
		XOR4(out4,out0,out6,in1);
		XOR3(out3,tmp0,out4);
		XOR4(out2,out4,out7,in7);
		XOR3(out5,out3,in0);
...
static void gf8_muladd_20(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp0,tmp1);
		XOR3(out7,tmp1,in2);
		XOR4(out6,tmp1,in1,in5);
		XOR4(out5,out2,out3,in0);
...
static void gf8_muladd_21(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in3,in5);
		XOR3(out7,in2,in6);
		XOR4(out0,in0,in3,in7);
		XOR4(out6,in1,in5,in7);
		XOR3(out3,tmp0,in7);
		XOR3(out5,tmp0,in0);
		XOR4(out2,out4,in2,in7);
...
static void gf8_muladd_22(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in0,in4);
		XOR3(out7,in2,in7);
		XOR4(out4,in4,in5,in7);
		XOR4(out5,in0,in5,in6);
		XOR4(out6,in1,in6,in7);
		XOR5(out3,in2,in3,in4,in6);
		XOR4(out2,in1,in3,in5);
...
static void gf8_muladd_23(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in0,in6);
		XOR3(out6,in1,in7);
		XOR4(out3,in2,in4,in6);
		XOR4(out1,in0,in1,in4);
		XOR5(out2,out4,out6,in2,in3);
...
static void gf8_muladd_24(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in4,in7);
		XOR3(tmp0,in3,in4);
		XOR4(out0,in3,in6,in7);
		XOR3(out3,tmp0,in1);
		XOR3(tmp1,out0,in5);
		XOR3(out6,tmp1,out3);
		XOR3(out2,tmp1,in0);
		XOR4(out7,tmp1,in2,in3);
		XOR3(out5,out2,in4);
		XOR3(out4,tmp0,out7);
...
static void gf8_muladd_26(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,in3,in6);
		XOR3(tmp0,in4,in7);
		XOR4(out7,in2,in5,in7);
		XOR4(tmp1,out0,in0,in5);
		XOR3(out1,tmp0,in0);
		XOR3(tmp2,tmp0,in6);
		XOR3(out2,tmp1,in1);
		XOR3(out5,tmp1,in7);
...
static void gf8_muladd_27(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,in2,in5);
		XOR4(out0,in0,in3,in6);
		XOR4(out6,in1,in4,in7);
		XOR3(out4,out7,in6);
		XOR4(out2,out0,out7,in1);
		XOR3(out5,out0,in7);
		XOR3(out1,out6,in0);
		XOR3(out3,out6,in2);
...
static void gf8_muladd_29(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in1,in3);
		XOR3(tmp1,in4,in6);
		XOR4(tmp2,in0,in4,in7);
		XOR3(out6,tmp0,in5);
		XOR4(out4,tmp0,in6,in7);
		XOR3(out1,tmp1,in1);
		XOR3(out7,tmp1,in2);
		XOR3(out3,tmp2,in5);
		XOR3(out5,tmp2,in2);
		XOR4(out0,out3,in3,in4);
...
static void gf8_muladd_2A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in1,in3);
		XOR3(tmp1,in0,in4);
		XOR4(out7,in2,in4,in7);
		XOR4(out3,tmp1,out0,in2);
		XOR3(out2,tmp0,in7);
		XOR3(out6,tmp0,in6);
		XOR3(out1,tmp1,in6);
		XOR4(out5,tmp1,out7,in5);
		XOR4(out4,out1,in0,in1);
...
static void gf8_muladd_2C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in2,in5);
		XOR4(tmp1,in2,in3,in4);
		XOR3(tmp2,tmp0,in6);
		XOR3(out4,tmp1,in1);
		XOR4(out5,tmp1,in0,in5);
		XOR3(tmp3,tmp2,in4);
		XOR3(out6,tmp2,out4);
		XOR3(out7,tmp3,in7);
		XOR3(out2,tmp3,out5);
...
static void gf8_muladd_2D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp3,in7);
		XOR3(out7,tmp3,out5);
		XOR4(out6,out4,out7,in6);
		XOR3(out3,tmp2,out6);
		XOR4(out1,out0,out6,in0);
...
static void gf8_muladd_2E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in7);
		XOR4(out0,in3,in5,in6);
		XOR3(tmp1,tmp0,in0);
		XOR3(tmp2,tmp0,in2);
		XOR3(out1,tmp1,in6);
		XOR3(out4,tmp2,in1);
		XOR3(out7,tmp2,in5);
		XOR4(out3,out0,out4,in0);
		XOR4(out2,out3,out7,in7);
		XOR3(out6,tmp1,out2);
		XOR4(out5,tmp1,out7,in3);
...
static void gf8_muladd_2F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in3);
		XOR3(tmp1,in2,in5);
		XOR4(out4,in1,in2,in7);
		XOR4(out6,in1,in3,in4);
		XOR3(out5,tmp0,in2);
		XOR3(tmp2,tmp0,in6);
		XOR3(out7,tmp1,in4);
		XOR3(out0,tmp2,in5);
		XOR3(out2,tmp2,out4);
		XOR4(out1,tmp2,out6,in7);
		XOR3(out3,tmp1,out1);
...
static void gf8_muladd_30(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in6);
		XOR3(tmp1,in4,in7);
		XOR4(out6,in1,in2,in5);
		XOR3(out3,tmp0,in5);
		XOR3(out4,tmp0,in0);
		XOR3(out7,tmp0,in2);
		XOR3(out0,tmp1,in3);
		XOR3(out2,tmp1,out3);
		XOR4(out5,tmp1,in0,in1);
...
static void gf8_muladd_31(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in5,in6);
		XOR3(tmp0,in4,in5);
		XOR4(tmp1,in0,in3,in4);
		XOR3(tmp2,out3,in2);
		XOR3(out1,tmp0,in1);
		XOR3(out0,tmp1,in7);
		XOR3(out4,tmp1,in6);
		XOR3(out6,tmp2,in1);
		XOR4(out2,tmp2,out0,in0);
		XOR4(out5,out1,in0,in7);
		XOR3(out7,tmp0,out2);
...
static void gf8_muladd_32(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in0,in7);
		XOR3(out6,in1,in2);
		XOR4(out1,in0,in4,in5);
		XOR4(out2,tmp0,out0,in1);
		XOR4(out3,tmp0,out7,in7);
		XOR3(out4,tmp1,in6);
		XOR3(out5,tmp1,in1);
...
static void gf8_muladd_33(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in0,in4);
		XOR3(tmp2,in1,in5);
		XOR4(out6,in1,in2,in6);
		XOR3(out7,tmp0,in7);
		XOR3(out0,tmp1,in3);
		XOR3(out1,tmp1,tmp2);
		XOR3(tmp3,tmp2,in7);
		XOR4(tmp4,tmp2,in4,in6);
		XOR3(out5,tmp3,in0);
		XOR3(out3,tmp3,out6);
		XOR3(out4,tmp4,out5);
		XOR3(out2,tmp0,tmp4);
...
static void gf8_muladd_35(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in2,in6);
		XOR3(tmp1,in5,in7);
		XOR4(out7,tmp0,tmp1,in3);
		XOR3(out3,tmp1,in1);
		XOR3(out1,out3,in4);
		XOR3(tmp2,out1,in7);
		XOR4(out5,tmp2,in0,in3);
		XOR3(out6,tmp0,tmp2);
		XOR4(out0,out3,out5,in6);
		XOR3(out4,tmp0,out0);
		XOR3(out2,out4,in5);
...
static void gf8_muladd_36(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in0,in2);
		XOR3(tmp0,in1,in3);
		XOR4(out0,in3,in4,in6);
		XOR4(out6,in1,in2,in4);
		XOR3(out5,tmp0,in0);
		XOR3(tmp1,out5,in5);
		XOR3(out2,tmp1,in4);
		XOR3(out3,tmp1,out4);
		XOR4(out1,tmp0,out2,in7);
		XOR3(out7,out3,in1);
...
static void gf8_muladd_37(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp1,in0);
		XOR3(out6,tmp2,in4);
		XOR4(out1,out3,out4,in7);
		XOR4(tmp3,out4,in1,in3);
		XOR3(out7,tmp3,out1);
		XOR3(out2,tmp3,in5);
		XOR3(out5,tmp1,out2);
		XOR3(out0,tmp2,tmp3);
...
static void gf8_muladd_38(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp1,tmp2);
		XOR3(out7,out2,in2);
		XOR4(out1,out2,in3,in5);
		XOR4(out6,out4,in0,in2);
		XOR3(out5,tmp2,out7);
...
static void gf8_muladd_39(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,tmp0,in4);
		XOR3(out1,tmp1,in6);
		XOR4(out5,out1,in0,in2);
		XOR3(tmp2,tmp0,out5);
		XOR4(out2,tmp2,in0,in3);
		XOR3(out7,out2,in7);
		XOR3(out6,tmp1,out7);
		XOR3(out4,tmp2,out6);
		XOR3(out0,out4,in1);
...
static void gf8_muladd_3A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	{
		encode_t out0, out1, out2, out3, out4, out5, out6, out7;
		encode_t tmp0, tmp1, tmp2, tmp3, tmp4, tmp5;
...
static void gf8_muladd_3B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,out6,in4);
		XOR3(out7,tmp0,out2);
		XOR4(out0,out3,out7,in5);
		XOR4(out5,out0,out2,in7);
		XOR3(out1,tmp2,out0);
		XOR3(out4,out1,in6);
...
static void gf8_muladd_3C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in3);
		XOR3(tmp1,in2,in7);
		XOR4(tmp2,in1,in6,in7);
		XOR3(out2,tmp0,in4);
		XOR3(out3,tmp0,tmp2);
		XOR4(out4,tmp1,out3,in5);
		XOR4(out5,tmp2,out2,in2);
		XOR4(out1,out4,out5,in6);
		XOR3(out0,out1,in3);
		XOR3(out7,tmp1,out0);
		XOR3(out6,tmp2,out7);
...
static void gf8_muladd_3E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp1,in6);
		XOR3(out7,tmp1,in2);
		XOR5(out6,out7,in1,in5,in7);
		XOR4(out2,out6,in0,in2);
		XOR4(out4,out0,out6,in0);
		XOR3(out5,tmp0,out4);
		XOR3(out3,out5,in7);
		XOR4(out1,out3,out6,in5);
...
static void gf8_muladd_3F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in1);
		XOR4(out3,tmp0,in2,in6);
		XOR4(tmp1,out3,in5,in7);
		XOR3(out4,tmp1,in4);
		XOR3(out5,tmp1,in3);
		XOR3(out1,out4,in2);
		XOR4(out7,out1,out3,in3);
		XOR4(out2,tmp0,out7,in5);
		XOR3(tmp2,out2,in0);
		XOR3(out6,tmp2,in6);
		XOR3(out0,tmp1,tmp2);
...
static void gf8_muladd_40(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,tmp0,in5);
		XOR3(out0,tmp1,in2);
		XOR4(out7,tmp1,in1,in5);
		XOR3(out2,out0,in4);
		XOR4(out3,out2,out5,in7);
		XOR4(out6,out3,out4,in0);
...
static void gf8_muladd_41(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in6,in7);
		XOR3(out5,in3,in4);
		XOR4(out1,in1,in3,in7);
		XOR4(out6,in0,in4,in5);
		XOR3(out3,tmp0,in2);
		XOR3(out7,tmp0,in1);
		XOR3(out2,tmp1,in4);
		XOR4(out0,tmp1,in0,in2);
...
static void gf8_muladd_42(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,in2,in6);
		XOR3(out5,in3,in5);
		XOR4(out1,in0,in3,in7);
		XOR4(out7,in1,in5,in7);
		XOR4(out4,in2,in4,in7);
		XOR4(out6,in0,in4,in6);
		XOR4(out2,out0,in1,in4);
		XOR4(out3,out5,in6,in7);
...
static void gf8_muladd_43(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in2,in7);
		XOR3(out6,in0,in4);
		XOR4(out0,in0,in2,in6);
		XOR4(out3,in5,in6,in7);
		XOR4(out2,in1,in4,in6);
		XOR5(out1,in0,in1,in3,in7);
...
static void gf8_muladd_44(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,in2,in7);
		XOR3(tmp0,in4,in7);
		XOR4(out7,in1,in6,in7);
		XOR4(out6,in0,in5,in6);
		XOR4(out4,tmp0,in3,in6);
		XOR5(out3,out0,in1,in3,in5);
		XOR4(out2,out0,in0,in4);
		XOR3(out5,tmp0,in5);
...
static void gf8_muladd_45(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in4,in7);
		XOR3(out6,in0,in5);
		XOR4(out0,in0,in2,in7);
		XOR4(out4,in3,in6,in7);
		XOR3(out2,out5,in0);
		XOR4(out3,out0,out6,in1);
...
static void gf8_muladd_46(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in5,in7);
		XOR3(out6,in0,in6);
		XOR4(out3,in1,in3,in5);
		XOR5(out2,out4,out6,in1,in2);
...
static void gf8_muladd_48(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in2,in3);
		XOR4(out1,in3,in6,in7);
		XOR3(out3,tmp0,in0);
		XOR4(out0,tmp0,out1,in5);
		XOR3(tmp1,out0,in4);
		XOR3(out2,tmp1,in7);
		XOR3(out5,tmp1,in3);
		XOR3(out4,out5,in1);
...
static void gf8_muladd_49(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in0,in2);
		XOR3(tmp0,in2,in5);
		XOR4(out2,in4,in5,in6);
		XOR4(tmp1,tmp0,out2,in3);
		XOR3(out7,out2,in1);
		XOR3(out5,tmp1,in7);
		XOR4(out4,out5,out7,in6);
		XOR3(out1,tmp0,out4);
		XOR4(out6,out1,out7,in0);
		XOR3(out0,tmp1,out6);
...
static void gf8_muladd_4B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out6,tmp2,in4);
		XOR3(out5,tmp2,tmp3);
		XOR4(out1,tmp2,in1,in6);
		XOR4(out2,out7,in6,in7);
		XOR3(out0,tmp3,in5);
...
static void gf8_muladd_4C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in3,in6);
		XOR3(tmp0,in2,in5);
		XOR4(tmp1,out1,in5,in7);
		XOR3(out0,tmp0,in7);
		XOR3(tmp2,tmp0,in4);
		XOR3(out6,tmp1,in0);
		XOR3(out2,tmp2,in0);
		XOR3(out5,tmp2,in6);
		XOR4(out3,tmp0,out6,in1);
		XOR4(out7,out0,out5,in1);
		XOR3(out4,tmp1,out7);
...
static void gf8_muladd_4D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp2,in2);
		XOR3(out6,tmp2,in3);
		XOR4(out5,out7,in1,in2);
		XOR4(out3,tmp1,out0,in5);
...
static void gf8_muladd_4E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,in2,in5);
		XOR4(out7,in1,in4,in7);
		XOR4(out1,in0,in3,in6);
		XOR3(out5,out0,in6);
		XOR3(out4,out7,in5);
		XOR3(out3,out1,in1);
		XOR3(out6,out1,in7);
		XOR4(out2,out4,in0,in2);
...
static void gf8_muladd_4F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in2,in6);
		XOR3(out7,in1,in4);
		XOR4(out3,in0,in1,in6);
		XOR4(out4,in1,in5,in7);
		XOR4(out0,in0,in2,in5);
		XOR4(out6,in0,in3,in7);
		XOR3(out1,out3,in3);
		XOR4(out2,out4,in0,in4);
...
static void gf8_muladd_50(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in2,in7);
		XOR3(tmp0,in3,in5);
		XOR4(out0,out2,in4,in6);
		XOR3(out1,tmp0,in7);
		XOR3(tmp1,tmp0,in6);
		XOR3(out3,out0,in3);
		XOR3(out7,tmp1,in1);
		XOR3(tmp2,tmp1,in0);
		XOR4(out5,out3,in1,in2);
		XOR3(out4,tmp2,in2);
		XOR3(out6,tmp2,out3);
...
static void gf8_muladd_51(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out2 = in7;
		XOR5(out3,in2,in4,in6,in7);
		XOR3(out0,out3,in0);
		XOR3(out6,out0,in5);
		XOR4(out4,out6,in3,in7);
		XOR4(out1,out0,out4,in1);
		XOR3(out7,out1,in6);
		XOR3(out5,out7,in4);
...
static void gf8_muladd_52(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp1,tmp3);
		XOR3(out3,tmp2,in4);
		XOR4(out5,tmp2,in1,in7);
		XOR4(out4,tmp2,out1,in2);
...
static void gf8_muladd_53(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out2 = in1;
		XOR3(out3,in4,in6);
		XOR4(out0,out3,in0,in2);
		XOR3(out6,out0,in7);
		XOR3(out4,out6,in5);
		XOR5(out7,out0,out4,in1,in3);
		XOR3(out1,out7,in0);
		XOR3(out5,out7,in6);
...
static void gf8_muladd_55(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp0,in5);
		XOR3(out3,tmp1,in2);
		XOR4(out5,tmp1,in5,in6);
		XOR3(out2,tmp2,in0);
		XOR4(out4,out5,out7,in0);
		XOR4(out6,out2,in2,in5);
		XOR4(out0,out5,out6,in1);
...
static void gf8_muladd_57(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in5);
		XOR3(tmp1,in1,in7);
		XOR4(out0,in0,in2,in4);
		XOR4(out5,in1,in5,in6);
		XOR3(out4,tmp0,in4);
		XOR4(out1,tmp0,in1,in3);
		XOR3(out2,tmp0,out5);
		XOR3(out3,tmp1,in4);
		XOR3(out7,tmp1,in3);
		XOR4(out6,tmp1,out2,in2);
...
static void gf8_muladd_58(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in2,in5);
		XOR4(tmp0,in2,in3,in4);
		XOR3(out5,tmp0,in1);
		XOR4(out6,tmp0,in0,in5);
		XOR3(out3,out6,in7);
		XOR3(tmp1,out2,out5);
		XOR3(out7,tmp1,in6);
		XOR4(out4,tmp1,out3,in3);
		XOR4(out0,out4,out7,in0);
		XOR3(out1,tmp0,out0);
...
static void gf8_muladd_59(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out2 = in5;
		XOR4(tmp0,in0,in5,in7);
		XOR4(out3,tmp0,in2,in4);
		XOR3(out0,out3,in6);
		XOR3(tmp1,out0,in7);
		XOR3(out6,tmp1,in3);
		XOR5(out5,out6,in0,in1,in6);
		XOR3(out4,tmp0,out5);
		XOR3(out1,tmp1,out4);
		XOR3(out7,out1,in4);
...
static void gf8_muladd_5A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp0,in0);
		XOR3(tmp2,tmp1,in4);
		XOR4(out2,tmp1,in1,in7);
		XOR3(out7,tmp2,out5);
		XOR4(out6,out4,out7,in5);
		XOR3(out0,tmp2,in6);
		XOR4(out1,out0,out6,in7);
		XOR3(out3,tmp1,out6);
...
static void gf8_muladd_5C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,tmp2,in4);
		XOR3(out3,tmp1,out7);
		XOR4(out0,out3,out4,in7);
		XOR4(out5,out0,in1,in5);
...
static void gf8_muladd_61(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,out4,in3);
		XOR3(out3,tmp1,in7);
		XOR4(out2,tmp1,in2,in6);
		XOR4(out1,tmp0,out3,in1);
		XOR4(out0,out2,out4,in0);
		XOR3(out7,tmp1,out1);
		XOR4(out6,out0,out1,in2);
		XOR3(out5,tmp0,out0);
...
static void gf8_muladd_64(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in5);
		XOR3(tmp1,in0,in7);
		XOR4(out4,in5,in6,in7);
		XOR4(out2,tmp0,out0,in0);
		XOR4(out3,tmp0,out7,in6);
		XOR3(out5,tmp1,in6);
		XOR3(out6,tmp1,in1);
...
static void gf8_muladd_65(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in4,in5);
		XOR3(tmp2,in6,in7);
		XOR4(out7,in1,in2,in7);
		XOR4(out1,in1,in3,in4);
		XOR3(out0,tmp0,in2);
		XOR3(out2,tmp0,tmp1);
		XOR3(out4,tmp1,tmp2);
		XOR3(tmp3,tmp2,in0);
		XOR4(out3,out4,out7,in3);
		XOR3(out5,tmp3,in5);
		XOR3(out6,tmp3,in1);
...
static void gf8_muladd_66(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,tmp3,in7);
		XOR3(out4,tmp3,tmp4);
		XOR4(out2,tmp0,tmp4,in7);
		XOR4(out6,tmp1,out2,in4);
		XOR3(out3,tmp3,out6);
...
static void gf8_muladd_67(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp3,out1,in7);
		XOR3(out2,tmp3,in5);
		XOR4(out3,out2,in0,in6);
		XOR4(out7,tmp1,out0,in6);
		XOR3(out5,tmp1,out3);
		XOR3(out4,tmp2,out5);
		XOR3(out6,tmp3,out4);
...
static void gf8_muladd_69(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in6,in7);
		XOR4(out2,tmp0,in3,in4);
		XOR3(out1,out2,in1);
		XOR4(out3,out2,in0,in2);
		XOR4(out4,out1,in2,in3);
		XOR4(out6,out1,in0,in7);
		XOR4(out7,out4,in5,in6);
		XOR4(out5,out4,out6,in5);
		XOR3(out0,tmp0,out5);
...
static void gf8_muladd_6A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp2,in5);
		XOR3(out5,tmp2,out3);
		XOR4(out7,out2,in3,in5);
		XOR3(out1,tmp0,out5);
		XOR4(out6,tmp1,out7,in0);
...
static void gf8_muladd_6B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in6);
		XOR4(out2,tmp0,in1,in3);
		XOR3(out4,out2,in2);
		XOR3(tmp1,out2,in0);
		XOR5(out7,out4,in3,in5,in7);
		XOR3(out1,tmp1,in7);
		XOR3(out3,tmp1,in1);
		XOR3(out6,tmp1,in5);
		XOR4(out0,tmp1,out7,in6);
		XOR3(out5,tmp0,out0);
...
static void gf8_muladd_6C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in2,in3);
		XOR3(out5,in0,in2);
		XOR4(out1,in3,in4,in6);
		XOR3(tmp1,out5,in1);
		XOR3(out0,tmp0,in5);
		XOR3(out6,tmp0,tmp1);
		XOR3(out3,tmp1,in4);
		XOR3(out7,out3,in0);
		XOR4(out2,out6,out7,in7);
...
static void gf8_muladd_6D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in2);
		XOR3(tmp1,out4,in3);
		XOR4(out7,out4,in2,in7);
		XOR3(out5,tmp0,in5);
		XOR3(out3,tmp0,tmp1);
		XOR3(out1,tmp1,in6);
		XOR3(out0,out5,in3);
		XOR4(out2,out3,out7,in4);
		XOR4(out6,out1,in0,in4);
...
static void gf8_muladd_6E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp2,in6);
		XOR3(out2,tmp0,out5);
		XOR4(out0,out2,out3,in5);
		XOR4(out7,out1,out2,in4);
...
static void gf8_muladd_6F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in7);
		XOR3(tmp1,tmp0,in4);
		XOR4(tmp2,tmp0,in0,in2);
		XOR3(out4,tmp1,in1);
		XOR3(out0,tmp2,in5);
		XOR3(out3,out4,in0);
		XOR3(out2,out3,in7);
		XOR3(out1,out2,in6);
		XOR4(out6,out1,in4,in5);
		XOR3(out7,tmp2,out1);
		XOR3(out5,tmp1,out0);
...
static void gf8_muladd_71(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp2,tmp0,in1);
		XOR3(out7,tmp1,in2);
		XOR4(out1,tmp1,in4,in7);
		XOR4(out0,out4,in3,in4);
		XOR3(out6,tmp2,in4);
		XOR4(out5,tmp2,out3,in7);
...
static void gf8_muladd_73(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in3,in7);
		XOR4(out2,out3,in1,in5);
		XOR4(out1,out2,in0,in4);
		XOR3(out5,out1,in5);
		XOR4(out6,out1,out3,in2);
		XOR4(out0,out2,out6,in6);
		XOR4(out7,out0,out1,in3);
		XOR3(out4,out0,in4);
...
static void gf8_muladd_74(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in4);
		XOR4(tmp1,in1,in2,in6);
		XOR4(out4,in0,in4,in7);
		XOR4(out5,in0,in1,in5);
		XOR3(out0,tmp0,in2);
		XOR3(out1,tmp0,in5);
		XOR3(out3,tmp1,in7);
		XOR3(out6,tmp1,in0);
		XOR4(out2,tmp1,out5,in3);
		XOR4(out7,out3,in3,in6);
...
static void gf8_muladd_77(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp0,tmp2);
		XOR3(out3,tmp1,in3);
		XOR4(out2,tmp1,tmp2,in7);
		XOR3(out7,out3,in2);
		XOR3(tmp3,out7,in6);
		XOR3(out6,tmp2,tmp3);
		XOR4(out0,tmp3,out5,in7);
...
static void gf8_muladd_78(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in3);
		XOR3(tmp1,in2,in7);
		XOR4(tmp2,in0,in5,in6);
		XOR3(out2,tmp1,in3);
		XOR3(out3,tmp2,in2);
		XOR4(out5,out3,in1,in3);
		XOR4(out0,tmp0,out3,in4);
		XOR3(out1,tmp1,out0);
		XOR4(out4,out1,out5,in5);
		XOR3(out7,tmp0,out4);
		XOR3(out6,tmp2,out7);
...
static void gf8_muladd_79(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in1,in5);
		XOR3(tmp2,tmp1,in2);
		XOR4(out4,tmp2,in0,in7);
		XOR3(tmp3,out4,in5);
		XOR4(out5,tmp3,out2,in6);
		XOR3(out7,tmp0,tmp2);
		XOR3(out6,tmp0,tmp3);
		XOR3(out3,tmp1,out5);
		XOR3(out0,out3,in4);
...
static void gf8_muladd_7B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in1,in3);
		XOR3(tmp0,in0,in5);
		XOR4(out4,tmp0,out2,in2);
		XOR3(tmp1,out4,in4);
		XOR3(out6,tmp1,in7);
		XOR4(out5,tmp1,in5,in6);
		XOR4(out0,out6,in1,in6);
		XOR3(tmp2,out0,in2);
		XOR3(out1,tmp2,in1);
		XOR3(out3,tmp2,in4);
		XOR3(out7,tmp0,out5);
...
static void gf8_muladd_7C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp1,in2);
		XOR3(out1,tmp1,in6);
		XOR5(out7,out0,in1,in5,in7);
		XOR4(out5,out1,out7,in0);
		XOR3(out3,out5,in6);
		XOR3(out6,tmp0,out5);
		XOR3(out2,out6,in1);
		XOR4(out4,out2,out7,in5);
...
static void gf8_muladd_7D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp3,tmp2,in0);
		XOR3(out5,tmp3,in7);
		XOR4(out4,tmp3,in2,in5);
		XOR3(out2,tmp1,out5);
		XOR3(out6,tmp2,out2);
		XOR4(out0,out4,out7,in6);
		XOR3(out1,tmp3,out0);
		XOR3(out3,out6,in5);
...
static void gf8_muladd_7E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in4);
		XOR3(tmp1,in0,in5);
		XOR4(out1,tmp0,tmp1,in6);
		XOR3(out3,tmp1,in1);
		XOR4(out4,out1,in1,in7);
		XOR3(tmp2,out4,in3);
		XOR3(out5,tmp2,in2);
		XOR3(out6,tmp0,out5);
		XOR4(out7,tmp1,out4,in2);
		XOR4(out2,out6,in5,in7);
		XOR3(out0,tmp2,out2);
...
static void gf8_muladd_80(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in2,in3);
		XOR3(tmp1,in4,in5);
		XOR4(out1,in2,in6,in7);
		XOR3(out5,tmp0,in4);
		XOR3(tmp2,tmp0,in1);
		XOR3(out6,tmp1,in3);
		XOR4(out7,tmp1,in0,in6);
		XOR3(out4,tmp2,in7);
		XOR3(out3,tmp2,out6);
		XOR4(out2,out3,out5,in6);
		XOR4(out0,out2,in3,in7);
...
static void gf8_muladd_81(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,tmp0,in3);
		XOR3(out6,tmp1,in5);
		XOR4(out5,out6,in2,in6);
		XOR3(out3,out5,in1);
		XOR3(out2,tmp0,out3);
		XOR4(out1,out3,out6,in7);
		XOR3(out4,tmp1,out1);
		XOR4(out7,out2,out4,in0);
		XOR4(out0,out7,in1,in4);
...
static void gf8_muladd_82(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in2,in3);
		XOR3(out6,in3,in4);
		XOR4(out7,in0,in4,in5);
		XOR4(out0,in1,in5,in6);
		XOR4(out1,tmp0,in0,in2);
		XOR4(out2,tmp0,in3,in5);
		XOR4(out3,tmp0,out0,in4);
...
static void gf8_muladd_83(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in2,in5);
		XOR3(tmp2,in3,in6);
		XOR4(out4,in1,in2,in4);
		XOR4(out0,tmp0,in5,in6);
		XOR3(out5,tmp1,in3);
		XOR3(tmp3,tmp1,in7);
		XOR3(out6,tmp2,in4);
		XOR3(out2,tmp2,tmp3);
...
static void gf8_muladd_84(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in2,in6);
		XOR3(out6,in3,in5);
		XOR4(out0,in1,in5,in7);
		XOR4(out7,in0,in4,in6);
		XOR4(out4,in1,in3,in6);
		XOR4(out5,in2,in4,in7);
		XOR4(out2,out6,in0,in1);
		XOR4(out3,out5,in5,in6);
...
static void gf8_muladd_85(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp3,out1,out6);
		XOR3(out2,tmp3,in0);
		XOR4(out3,tmp2,tmp3,in7);
		XOR4(out7,out2,out3,in1);
		XOR3(out5,tmp1,out3);
		XOR4(out0,tmp2,out7,in5);
...
static void gf8_muladd_86(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,in1,in5);
		XOR3(out5,in2,in7);
		XOR4(out3,in4,in5,in6);
		XOR4(out1,in0,in2,in6);
		XOR4(out4,in1,in6,in7);
		XOR5(out2,in0,in3,in5,in7);
...
static void gf8_muladd_87(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out6,in3,in6);
		XOR3(tmp0,in0,in1);
		XOR4(out7,in0,in4,in7);
		XOR4(out5,in2,in5,in7);
		XOR4(out3,out6,in4,in5);
		XOR3(out0,tmp0,in5);
		XOR3(tmp1,tmp0,in6);
		XOR4(out2,out5,in0,in3);
		XOR3(out1,tmp1,in2);
		XOR3(out4,tmp1,out7);
...
static void gf8_muladd_88(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in2,in7);
		XOR3(tmp0,in5,in6);
		XOR4(out0,in1,in6,in7);
		XOR4(out6,in4,in5,in7);
		XOR5(out3,out0,out1,in0,in4);
		XOR3(out7,tmp0,in0);
		XOR3(tmp1,tmp0,in3);
		XOR3(out2,out0,in3);
		XOR3(out4,tmp1,in2);
...
static void gf8_muladd_89(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,tmp2,in5);
		XOR3(out0,tmp2,in1);
		XOR4(out2,out1,in3,in6);
		XOR4(out6,out7,in0,in4);
		XOR3(out5,out6,in3);
		XOR4(out3,tmp0,out2,in4);
		XOR3(out4,tmp1,out5);
...
static void gf8_muladd_8A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in3,in6);
		XOR3(out6,in4,in7);
		XOR4(out1,in0,in2,in7);
		XOR4(out3,out0,out6,in0);
		XOR4(out4,out1,out7,in6);
		XOR3(out5,out2,in7);
...
static void gf8_muladd_8C(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in4,in6);
		XOR3(out6,in5,in7);
		XOR4(out2,out0,in0,in3);
		XOR5(out3,out5,out7,in2,in7);
		XOR3(out4,out6,in3);
...
static void gf8_muladd_8D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,in1,in2);
		XOR3(tmp0,in6,in7);
		XOR4(out0,in0,in1,in7);
		XOR4(out5,in4,in5,in6);
		XOR3(out6,tmp0,in5);
		XOR3(out7,tmp0,in0);
		XOR4(out4,tmp0,out5,in3);
		XOR4(out2,out0,in2,in3);
		XOR4(out3,out2,in1,in4);
...
static void gf8_muladd_91(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,tmp1,in1);
		XOR3(out6,tmp1,in7);
		XOR4(tmp2,out2,in5,in7);
		XOR3(out3,tmp2,in4);
		XOR3(out5,tmp2,in6);
		XOR4(out1,tmp1,out5,in2);
		XOR3(tmp3,out1,in0);
		XOR3(out4,tmp3,in3);
		XOR3(out0,tmp0,tmp3);
		XOR3(out7,tmp2,tmp3);
...
static void gf8_muladd_92(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in5);
		XOR3(tmp1,tmp0,in1);
		XOR4(out2,tmp0,in3,in7);
		XOR3(out0,tmp1,in6);
		XOR3(out7,out2,in0);
		XOR4(out4,out0,in0,in2);
		XOR4(out5,out4,out7,in5);
		XOR3(out6,tmp1,out5);
		XOR4(out1,out6,out7,in7);
...
static void gf8_muladd_94(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in2,in6);
		XOR4(tmp0,in1,in4,in5);
		XOR3(out1,out3,in5);
		XOR3(out5,tmp0,out3);
		XOR3(out0,tmp0,in7);
		XOR4(out4,tmp0,in0,in3);
		XOR4(out6,out1,in3,in7);
		XOR3(out2,out4,in6);
		XOR4(out7,out0,out2,in4);
...
static void gf8_muladd_96(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in1,in5);
		XOR3(tmp1,in5,in6);
		XOR4(out6,out3,in2,in3);
		XOR3(out0,tmp0,in4);
		XOR3(tmp2,tmp1,in2);
		XOR4(out4,out0,in0,in7);
		XOR3(out1,tmp2,in0);
		XOR3(out5,tmp2,in1);
		XOR4(out7,tmp0,out4,in3);
		XOR3(out2,tmp1,out7);
...
static void gf8_muladd_97(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in4);
		XOR3(tmp1,in2,in6);
		XOR4(out3,in3,in6,in7);
		XOR3(out7,tmp0,in3);
		XOR3(tmp2,tmp0,in5);
		XOR3(out5,tmp1,in1);
		XOR3(out6,tmp1,out3);
		XOR3(out0,tmp2,in1);
		XOR4(out2,tmp2,out3,in2);
		XOR3(tmp3,out0,in4);
		XOR3(out4,tmp3,in7);
		XOR3(out1,tmp1,tmp3);
...
static void gf8_muladd_98(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in5,in7);
		XOR4(tmp1,in1,in4,in7);
		XOR3(out1,tmp0,in2);
		XOR3(out0,tmp1,in6);
		XOR3(out2,tmp1,in3);
		XOR4(out6,out0,out1,in1);
		XOR3(out5,tmp0,out2);
		XOR4(out3,tmp1,out6,in0);
		XOR4(out7,out0,out5,in0);
		XOR4(out4,out6,out7,in7);
...
static void gf8_muladd_99(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in3);
		XOR4(out5,in1,in3,in4);
		XOR4(out6,in2,in4,in5);
		XOR3(out4,tmp0,in2);
		XOR3(tmp1,tmp0,in6);
		XOR3(tmp2,out5,in7);
		XOR3(out7,tmp1,in5);
...
static void gf8_muladd_9A(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in5);
		XOR3(tmp1,in1,in6);
		XOR4(out5,in1,in3,in5);
		XOR3(tmp2,tmp0,in7);
		XOR3(out3,tmp0,tmp1);
		XOR3(out0,tmp1,in4);
		XOR3(out7,tmp2,in3);
		XOR3(out1,tmp2,in2);
		XOR4(out6,out0,in1,in2);
		XOR4(out4,out1,in4,in5);
...
static void gf8_muladd_9B(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in5);
		XOR3(out6,in2,in4);
		XOR4(out4,in0,in2,in7);
		XOR3(out7,tmp0,in0);
		XOR3(out2,out6,in3);
		XOR4(out1,out4,in1,in5);
		XOR4(out3,out7,in1,in6);
		XOR4(out0,tmp0,out3,in4);
...
static void gf8_muladd_9D(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out6,in2,in5);
		XOR3(tmp0,in0,in3);
		XOR4(out5,in1,in4,in7);
		XOR3(out1,out6,in1);
		XOR3(out3,tmp0,out6);
		XOR3(out7,tmp0,in6);
		XOR3(out0,out5,in0);
		XOR3(out4,out7,in7);
		XOR4(out2,out5,out7,in2);
...
static void gf8_muladd_9E(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in5);
		XOR3(out6,in2,in6);
		XOR4(out7,in0,in3,in7);
		XOR4(out4,in0,in4,in6);
		XOR4(out5,in1,in5,in7);
		XOR3(out1,tmp0,in2);
		XOR3(out3,tmp0,in7);
		XOR3(out2,out4,in3);
...
static void gf8_muladd_9F(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in0,in6);
		XOR3(out5,in1,in7);
		XOR4(out1,tmp0,in2,in5);
		XOR5(out2,out7,in2,in4,in6);
		XOR4(out3,out7,in5,in7);
		XOR3(out0,tmp0,in4);
...
static void gf8_muladd_A1(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp1,in7);
		XOR3(out7,tmp2,in0);
		XOR4(out6,tmp2,out4,in3);
		XOR3(out3,out4,in6);
		XOR3(out2,out3,in5);
		XOR3(out1,out2,in4);
		XOR4(out5,out1,out6,in0);
		XOR3(out0,tmp1,out5);
...
static void gf8_muladd_A2(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out2 = in6;
		XOR4(tmp0,in1,in3,in5);
		XOR3(out3,tmp0,in6);
		XOR4(out4,tmp0,in2,in4);
		XOR3(out0,out3,in7);
		XOR3(out6,out0,in4);
		XOR4(out1,out0,out4,in0);
		XOR3(out7,out1,in5);
		XOR4(out5,out7,in3,in7);
...
static void gf8_muladd_A3(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in2,in6);
		XOR4(out3,in1,in5,in6);
		XOR3(tmp0,out2,in0);
		XOR4(out4,out2,out3,in3);
		XOR3(tmp1,tmp0,in4);
		XOR4(out0,tmp0,out4,in7);
		XOR3(out5,tmp1,in3);
		XOR3(out7,tmp1,in5);
		XOR4(out1,tmp1,in1,in7);
		XOR4(out6,tmp1,out0,in2);
...
static void gf8_muladd_A5(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in0,in1);
		XOR3(tmp2,in2,in4);
		XOR4(out6,in1,in3,in7);
		XOR3(out4,tmp0,in5);
		XOR3(out1,tmp0,tmp2);
		XOR4(out0,tmp1,in3,in5);
		XOR4(out2,tmp1,in2,in7);
		XOR3(out7,tmp2,in0);
		XOR3(out5,tmp0,out2);
...
static void gf8_muladd_A6(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out2 = in0;
		XOR4(out3,in3,in5,in7);
		XOR5(out1,in0,in2,in4,in6);
		XOR3(out0,out3,in1);
		XOR3(out7,out1,in7);
		XOR3(out6,out0,in6);
		XOR3(out5,out7,in5);
...
static void gf8_muladd_A7(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in0,in2);
		XOR3(out3,in5,in7);
		XOR4(out7,out2,in4,in6);
		XOR4(out6,out3,in1,in3);
		XOR3(out1,out7,in1);
		XOR3(out5,out7,in7);
		XOR3(out0,out6,in0);
		XOR3(out4,out6,in6);
...
static void gf8_muladd_A8(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out6,tmp1,in4);
		XOR3(out7,tmp2,in5);
		XOR4(out3,tmp2,out0,in6);
		XOR4(out5,out7,in2,in3);
...
static void gf8_muladd_A9(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in2,in6);
		XOR3(out6,in1,in4);
		XOR4(out7,in0,in2,in5);
		XOR4(out5,in0,in3,in7);
		XOR4(out2,out4,in1,in5);
		XOR4(out1,out6,in2,in7);
		XOR4(out0,out2,out7,in3);
		XOR4(out3,out1,in0,in4);
...
static void gf8_muladd_AA(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in1,in3);
		XOR3(tmp2,in6,in7);
		XOR4(out1,tmp0,in4,in7);
		XOR3(out3,tmp1,in0);
		XOR3(out0,tmp1,tmp2);
		XOR3(out2,tmp2,in5);
		XOR3(out7,tmp0,out2);
		XOR4(out6,out1,out7,in1);
		XOR4(out5,out0,out6,in0);
		XOR4(out4,out5,out7,in7);
...
static void gf8_muladd_AB(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in0,in7);
		XOR3(out6,tmp0,in5);
		XOR4(out1,tmp0,tmp1,in2);
		XOR4(out5,tmp1,in3,in4);
		XOR4(out0,tmp0,out5,in6);
		XOR4(out4,out0,out3,in2);
		XOR4(out2,out4,in3,in5);
		XOR3(out7,tmp1,out2);
...
static void gf8_muladd_AD(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out6 = in1;
		XOR3(out7,in0,in2);
		XOR4(out0,in0,in1,in3);
		XOR4(out2,out7,in1,in5);
		XOR4(out1,in1,in2,in4);
		XOR3(out3,out7,in6);
...
static void gf8_muladd_AF(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in0,in4);
		XOR3(out6,in1,in5);
		XOR4(out7,in0,in2,in6);
		XOR4(out0,tmp0,in1,in3);
		XOR3(out3,tmp0,in6);
		XOR4(out2,tmp0,in2,in5);
		XOR4(out1,out5,in1,in2);
...
static void gf8_muladd_B0(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp2,in2);
		XOR3(out6,out3,in6);
		XOR4(tmp3,out6,in0,in1);
		XOR3(out7,tmp3,in5);
		XOR3(out5,tmp3,out2);
		XOR4(out1,out0,out5,in0);
		XOR3(out4,tmp1,out5);
...
static void gf8_muladd_B1(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in1,in4);
		XOR4(out2,tmp0,in2,in7);
		XOR3(tmp1,out2,in6);
		XOR3(out1,tmp1,in5);
		XOR3(out3,tmp1,in7);
		XOR3(out4,tmp1,in0);
		XOR3(out6,out3,in3);
		XOR5(out0,out6,in0,in2,in5);
		XOR4(out5,tmp1,out0,in1);
		XOR3(out7,tmp0,out5);
...
static void gf8_muladd_B3(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in5);
		XOR3(tmp1,in1,in6);
		XOR4(out3,tmp1,in4,in7);
		XOR3(tmp2,tmp0,out3);
		XOR3(out0,tmp2,in3);
		XOR3(out1,tmp2,in2);
		XOR4(out5,out0,in2,in6);
		XOR3(out7,tmp1,out5);
		XOR5(out4,out7,in1,in5,in7);
		XOR3(out6,tmp0,out4);
...
static void gf8_muladd_B4(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,out4,in2);
		XOR3(tmp0,out4,in4);
		XOR4(out6,out5,in0,in3);
		XOR3(out7,tmp0,out6);
		XOR4(out2,tmp0,in6,in7);
		XOR4(out3,out7,in0,in7);
		XOR4(out0,out5,out7,in5);
		XOR4(out1,out0,out6,in6);
...
static void gf8_muladd_B5(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp1,in7);
		XOR3(tmp2,out4,in5);
		XOR4(out7,out3,in0,in3);
		XOR3(out0,tmp2,in3);
		XOR4(out2,tmp0,out3,in6);
		XOR3(out5,tmp1,tmp2);
		XOR4(out6,out2,out7,in2);
		XOR4(out1,tmp0,out0,out6);
...
static void gf8_muladd_B6(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in0,in4);
		XOR3(tmp2,in3,in5);
		XOR4(tmp3,out3,in1,in7);
		XOR3(out5,tmp0,tmp1);
		XOR3(out6,tmp0,tmp2);
		XOR3(out2,tmp1,in6);
		XOR3(out4,tmp1,tmp3);
		XOR3(out0,tmp3,in5);
		XOR4(out1,out2,in2,in5);
		XOR3(out7,tmp2,out1);
...
static void gf8_muladd_B7(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		out3 = in4;
		XOR3(tmp0,in0,in4);
		XOR4(out2,tmp0,in2,in6);
		XOR3(tmp1,out2,in7);
		XOR4(out1,out2,in1,in5);
		XOR3(out7,tmp1,in3);
		XOR3(out5,out1,in6);
		XOR4(out6,tmp0,out1,in3);
		XOR3(out0,tmp1,out6);
		XOR3(out4,out0,in5);
...
static void gf8_muladd_B8(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp2,in4);
		XOR3(out3,tmp0,out7);
		XOR4(out0,out3,out4,in6);
		XOR4(out5,out0,in0,in4);
...
static void gf8_muladd_B9(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in4,in5);
		XOR3(out4,tmp0,tmp1);
		XOR4(tmp2,tmp0,in3,in7);
		XOR3(out3,out4,in1);
		XOR3(out7,tmp2,in5);
		XOR3(out2,out3,in0);
		XOR3(out1,out2,in7);
		XOR4(out6,out1,in5,in6);
		XOR3(out0,tmp2,out6);
		XOR3(out5,tmp1,out0);
...
static void gf8_muladd_BA(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp1,in0);
		XOR3(out6,tmp1,in1);
		XOR4(out4,out1,in3,in4);
		XOR3(tmp2,out4,out6);
		XOR4(out7,out4,in6,in7);
		XOR3(out5,tmp2,in6);
		XOR3(out3,tmp0,tmp2);
		XOR4(out0,out6,out7,in0);
...
static void gf8_muladd_BB(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR5(out2,in2,in4,in5,in7);
		XOR3(tmp0,out2,in1);
		XOR4(out4,out2,in0,in3);
		XOR3(out1,tmp0,in0);
		XOR3(out6,tmp0,in6);
		XOR3(out3,out1,in2);
		XOR4(tmp1,out4,out6,in4);
		XOR3(out0,tmp1,in7);
		XOR3(out5,tmp1,in5);
		XOR3(out7,tmp0,tmp1);
...
static void gf8_muladd_BC(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in2);
		XOR3(tmp1,in2,in4);
		XOR4(out0,in1,in3,in4);
		XOR4(out6,in1,in2,in7);
		XOR3(out7,tmp0,in3);
		XOR4(out5,tmp0,out6,in6);
		XOR3(out1,tmp1,in5);
		XOR4(tmp2,out1,out5,in1);
		XOR3(out3,tmp2,in3);
		XOR3(out4,tmp1,tmp2);
		XOR3(out2,tmp2,out6);
...
static void gf8_muladd_BD(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in1,in4);
		XOR3(out0,tmp0,tmp1);
		XOR4(out7,tmp0,in2,in7);
		XOR4(out1,tmp1,in2,in5);
		XOR3(tmp2,out1,in0);
		XOR3(out2,tmp2,in6);
		XOR4(out3,out2,in1,in7);
		XOR3(out4,out3,in2);
		XOR3(out5,tmp1,out4);
		XOR3(out6,tmp2,out4);
...
static void gf8_muladd_BE(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,tmp0,in2);
		XOR3(out3,out4,in4);
		XOR4(out1,out3,out7,in0);
		XOR4(out2,out3,in3,in7);
		XOR4(out0,out2,out4,in1);
		XOR3(out5,tmp0,out0);
		XOR4(out6,out1,out5,in6);
...
static void gf8_muladd_BF(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in4);
		XOR4(out3,tmp0,in5,in6);
		XOR3(out4,out3,in3);
		XOR3(tmp1,out3,in7);
		XOR3(out2,tmp1,in2);
		XOR3(out5,tmp1,in1);
		XOR3(tmp2,out2,in5);
		XOR4(out7,tmp2,in3,in4);
		XOR3(tmp3,tmp0,out5);
		XOR3(out0,tmp3,out4);
		XOR3(out1,tmp2,tmp3);
		XOR3(out6,tmp3,in2);
...
static void gf8_muladd_C1(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in1,in7);
		XOR3(out6,in0,in3);
		XOR4(out3,in1,in4,in6);
		XOR3(tmp1,tmp0,in2);
		XOR3(out7,tmp0,in4);
		XOR3(out0,tmp1,in5);
		XOR4(out1,tmp1,out6,in6);
		XOR5(out2,out6,out7,in5,in7);
...
static void gf8_muladd_C2(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR4(out4,in1,in3,in4);
		XOR4(tmp0,in0,in3,in6);
		XOR4(out5,in2,in4,in5);
		XOR3(tmp1,out4,in7);
		XOR3(out1,tmp0,in2);
		XOR3(out6,tmp0,in5);
		XOR3(out2,out5,in3);
		XOR3(out7,tmp0,tmp1);
		XOR4(out3,tmp1,in2,in6);
		XOR3(out0,tmp1,out2);
...
static void gf8_muladd_C3(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,tmp1,in4);
		XOR3(out6,tmp1,in0);
		XOR4(out0,tmp1,tmp2,in7);
		XOR3(out1,tmp2,in6);
		XOR4(out7,out1,out5,in3);
		XOR4(out3,tmp0,out7,in7);
...
static void gf8_muladd_C4(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out1,tmp1,in6);
		XOR3(out5,tmp1,in5);
		XOR4(out4,out1,out3,in1);
		XOR4(out0,out4,in4,in5);
		XOR4(out2,out0,out3,in0);
		XOR4(out7,out1,out2,in7);
		XOR4(out6,tmp1,out0,out7);
...
static void gf8_muladd_C5(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in4,in7);
		XOR3(tmp0,in3,in7);
		XOR4(out4,in1,in2,in6);
		XOR4(out6,in0,in3,in4);
		XOR3(out5,tmp0,in2);
		XOR3(out1,tmp0,out4);
		XOR4(out0,out4,in0,in5);
		XOR4(out2,out0,out5,in4);
		XOR4(out7,tmp0,out2,in6);
...
static void gf8_muladd_C7(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in5);
		XOR3(tmp1,out3,in7);
		XOR4(out6,tmp0,in0,in4);
		XOR3(out5,tmp1,in3);
		XOR3(out2,out6,in6);
		XOR4(out7,out2,in1,in3);
		XOR3(out0,tmp1,out7);
		XOR3(out1,tmp0,out0);
		XOR3(out4,out1,in0);
...
static void gf8_muladd_C8(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in5,in6);
		XOR3(tmp1,in0,in7);
		XOR4(out2,out1,in1,in4);
		XOR3(out4,tmp0,in4);
		XOR3(out5,tmp0,in7);
		XOR3(out6,tmp1,in6);
		XOR3(out7,tmp1,in1);
		XOR5(out3,out2,in0,in2,in5);
...
static void gf8_muladd_CA(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out7,tmp2,in1);
		XOR3(out2,tmp3,in4);
		XOR4(out5,out6,in0,in4);
		XOR3(out4,out5,in3);
		XOR3(out1,tmp0,tmp3);
		XOR4(out3,tmp3,out5,out7);
...
static void gf8_muladd_CB(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in7);
		XOR3(tmp1,in5,in7);
		XOR4(out7,in0,in1,in6);
		XOR3(out5,tmp0,in6);
		XOR3(out2,tmp0,in3);
		XOR3(out6,tmp1,in0);
		XOR4(out4,tmp1,in3,in6);
		XOR4(tmp2,out5,out7,in2);
		XOR3(out1,tmp2,out2);
		XOR3(out0,tmp2,in4);
		XOR3(out3,tmp2,in5);
...
static void gf8_muladd_CC(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in5);
		XOR3(tmp1,in1,in6);
		XOR4(out1,in2,in3,in7);
		XOR3(out5,tmp0,in6);
		XOR3(out0,tmp1,in2);
		XOR4(tmp2,out5,in0,in7);
		XOR3(out3,tmp2,in4);
		XOR3(out6,tmp0,out3);
		XOR4(out7,tmp1,tmp2,in3);
		XOR3(tmp3,out1,out6);
		XOR3(out4,tmp2,tmp3);
		XOR3(out2,tmp3,in1);
...
static void gf8_muladd_CD(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in1);
		XOR3(tmp1,in2,in7);
		XOR4(out6,in0,in4,in7);
		XOR4(out2,tmp0,out5,in4);
		XOR3(out7,tmp0,in5);
		XOR4(out0,tmp0,in2,in6);
		XOR3(out4,tmp1,in5);
		XOR4(out1,tmp1,in1,in3);
		XOR4(out3,out6,in5,in6);
...
static void gf8_muladd_CE(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp2,in0);
		XOR3(out5,tmp2,in2);
		XOR4(out2,out3,in5,in7);
		XOR3(out6,tmp1,out2);
		XOR4(out7,out2,out4,in1);
		XOR3(out1,tmp2,out6);
		XOR4(out0,tmp0,out7,in0);
...
static void gf8_muladd_CF(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in3,in6);
		XOR4(tmp1,in0,in1,in5);
		XOR4(out4,in2,in3,in5);
		XOR3(out5,tmp0,in4);
		XOR3(out7,tmp1,in6);
		XOR4(out1,tmp1,out4,in7);
		XOR3(tmp2,out5,in0);
		XOR3(out2,tmp2,in7);
		XOR3(out3,tmp2,out4);
		XOR4(out6,tmp0,out2,in5);
		XOR3(out0,tmp0,out1);
...
static void gf8_muladd_D1(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp2,in4);
		XOR3(out7,tmp0,out4);
		XOR4(out6,tmp2,out1,in6);
		XOR4(out0,out2,out6,in4);
...
static void gf8_muladd_D2(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in5,in6);
		XOR4(out2,tmp0,in2,in3);
		XOR3(out1,out2,in0);
		XOR3(out3,out2,in1);
		XOR4(out4,out1,in1,in2);
		XOR4(out6,out1,in6,in7);
		XOR4(out7,out4,in4,in5);
		XOR4(out5,out4,out6,in4);
		XOR3(out0,tmp0,out5);
...
static void gf8_muladd_D3(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR4(out2,in3,in5,in6);
		XOR3(tmp0,out2,in2);
		XOR3(tmp1,tmp0,in1);
		XOR3(out1,tmp1,in0);
		XOR3(out3,tmp1,in3);
		XOR4(out4,out1,in2,in4);
		XOR3(tmp2,out4,in5);
		XOR3(out7,tmp2,in7);
		XOR3(out0,tmp0,out7);
		XOR3(tmp3,out0,in0);
...
static void gf8_muladd_D4(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp1,in0);
		XOR3(tmp2,tmp1,in6);
		XOR4(out2,out4,in3,in7);
		XOR3(out0,tmp2,in4);
		XOR3(out5,tmp2,out3);
		XOR4(out1,tmp0,out5,in7);
		XOR4(out6,tmp0,out2,in4);
		XOR4(out7,tmp1,out6,in7);
...
static void gf8_muladd_D6(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR5(tmp0,in1,in2,in4,in6);
		XOR3(out5,tmp0,in3);
		XOR4(out0,tmp0,in5,in7);
		XOR4(out3,out0,out5,in2);
		XOR3(tmp1,out3,in0);
		XOR3(out1,tmp1,in6);
		XOR3(out2,tmp1,in7);
		XOR3(out4,tmp1,in1);
...
static void gf8_muladd_D7(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in3);
		XOR4(out3,in2,in5,in7);
		XOR3(out2,tmp0,in5);
		XOR4(tmp1,tmp0,out3,in1);
		XOR3(out1,tmp1,in6);
		XOR3(out4,tmp1,in4);
		XOR3(tmp2,out1,in4);
		XOR3(out6,tmp2,in1);
...
static void gf8_muladd_D9(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,in0,in4);
		XOR3(out5,in1,in5);
		XOR4(out2,in1,in3,in6);
		XOR4(out3,in0,in1,in7);
		XOR4(out6,in0,in2,in6);
		XOR4(out0,out4,in1,in2);
		XOR4(out1,out5,in2,in3);
		XOR3(out7,out3,in3);
...
static void gf8_muladd_DA(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in1,in4);
		XOR3(tmp0,in2,in7);
		XOR4(tmp1,in0,in2,in3);
		XOR3(out0,tmp0,out5);
		XOR3(out4,tmp0,tmp1);
		XOR4(out2,tmp0,in3,in6);
		XOR3(out1,tmp1,in5);
		XOR3(out3,tmp1,in1);
		XOR3(out6,out1,in3);
		XOR4(out7,out3,in2,in6);
...
static void gf8_muladd_DC(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp1,in6);
		XOR3(tmp3,tmp1,in1);
		XOR4(out1,tmp1,tmp2,in5);
		XOR3(out4,tmp2,in6);
		XOR3(out2,tmp3,in2);
		XOR3(out7,tmp3,in5);
		XOR3(out5,tmp2,out2);
		XOR4(out0,out2,out3,in4);
...
static void gf8_muladd_DD(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in0,in6);
		XOR4(out2,in0,in1,in3);
		XOR4(out6,out3,in2,in4);
		XOR4(out7,out2,in5,in7);
		XOR3(out0,out6,in1);
		XOR3(out4,out6,in7);
		XOR3(out5,out7,in0);
		XOR3(out1,out5,in2);
...
static void gf8_muladd_DE(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR4(tmp0,in2,in3,in6);
		XOR4(tmp1,in3,in4,in7);
		XOR3(out4,tmp0,in0);
		XOR3(out5,tmp1,in1);
		XOR3(out3,out4,in7);
		XOR3(out2,out3,in6);
...
static void gf8_muladd_DF(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR4(out2,in0,in3,in7);
		XOR4(tmp0,out2,in1,in5);
		XOR3(out1,tmp0,in2);
		XOR3(out7,tmp0,in6);
		XOR4(out5,tmp0,in0,in4);
		XOR4(tmp1,out1,out5,in6);
		XOR3(out4,tmp1,in3);
		XOR3(out6,tmp1,in5);
		XOR3(tmp2,tmp1,in7);
		XOR3(out0,tmp2,in1);
...
static void gf8_muladd_E1(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out0,tmp2,in2);
		XOR3(out6,tmp2,in6);
		XOR4(tmp3,out0,out4,in6);
		XOR3(out5,tmp3,in5);
		XOR3(out7,tmp0,tmp3);
		XOR4(out1,tmp2,out5,in7);
...
static void gf8_muladd_E2(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in1,in2);
		XOR3(out4,in1,in5);
		XOR4(out2,in2,in4,in7);
		XOR4(out5,in0,in2,in6);
		XOR4(out0,out3,in3,in5);
		XOR4(out7,out3,in0,in4);
		XOR4(out6,out2,out7,in3);
		XOR4(out1,out5,in3,in4);
...
static void gf8_muladd_E5(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in1);
		XOR3(tmp1,in5,in7);
		XOR4(out2,tmp0,in4,in6);
		XOR3(tmp2,tmp1,out2);
		XOR3(out6,tmp2,in3);
		XOR3(out7,tmp2,in2);
		XOR4(out0,out6,in2,in4);
		XOR4(out5,out6,in1,in2);
		XOR4(out1,tmp0,out5,in5);
		XOR3(out4,tmp1,out1);
...
static void gf8_muladd_E6(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR4(out3,in2,in6,in7);
		XOR4(out2,out3,in0,in4);
		XOR4(out4,out3,in1,in5);
		XOR3(out1,out2,in3);
		XOR4(out7,out2,out4,in2);
		XOR4(out0,out4,in3,in7);
		XOR3(out5,out1,in4);
		XOR4(out6,out0,out2,in5);
...
static void gf8_muladd_E9(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out4,tmp1,in4);
		XOR3(out6,tmp2,in5);
		XOR4(out7,tmp2,in2,in7);
		XOR4(out3,out6,in3,in7);
		XOR3(out0,tmp1,out7);
		XOR4(out2,out3,out4,in0);
		XOR3(out5,tmp0,out2);
		XOR4(out1,out0,out5,in5);
...
static void gf8_muladd_EA(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,in0,in7);
		XOR3(out6,in0,in1);
		XOR4(out0,in1,in2,in3);
		XOR4(out2,in2,in4,in5);
		XOR3(out7,out6,in2);
		XOR4(out1,out0,out6,in4);
		XOR4(out3,out7,in5,in6);
...
static void gf8_muladd_EB(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out2,in4,in5);
		XOR3(tmp0,in0,in1);
		XOR4(out4,in4,in6,in7);
		XOR4(out5,in0,in5,in7);
		XOR3(out6,tmp0,in6);
		XOR3(tmp1,tmp0,in2);
		XOR3(out0,tmp1,in3);
		XOR3(out7,tmp1,in7);
		XOR3(out1,out0,in4);
		XOR4(out3,out0,in5,in6);
...
static void gf8_muladd_EC(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,in0,in5);
		XOR4(out4,in2,in3,in7);
		XOR4(out5,in0,in3,in4);
		XOR4(out6,out3,in1,in4);
		XOR3(out1,out4,in4);
		XOR4(out0,out4,in1,in6);
		XOR4(out2,out0,out5,in5);
		XOR4(out7,out2,in4,in7);
...
static void gf8_muladd_ED(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in2,in4);
		XOR3(tmp1,in3,in5);
		XOR4(out4,tmp0,in3,in7);
		XOR3(out3,tmp1,in0);
		XOR3(out1,out4,in1);
		XOR3(out5,out3,in4);
		XOR4(out7,out1,out5,in6);
		XOR3(out2,tmp0,out7);
		XOR3(out0,tmp1,out7);
		XOR3(out6,out2,in7);
...
static void gf8_muladd_EF(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out5,tmp0,in3);
		XOR3(out2,tmp0,tmp1);
		XOR4(out6,tmp1,in0,in1);
		XOR4(out3,out5,in2,in7);
		XOR4(out7,out3,in1,in3);
		XOR4(out0,out4,out6,in3);
		XOR4(out1,tmp1,out0,in7);
...
static void gf8_muladd_F0(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,tmp1,in1);
		XOR3(tmp2,tmp1,in7);
		XOR4(out1,out2,out3,in3);
		XOR3(tmp3,tmp0,tmp2);
		XOR3(out0,tmp3,in3);
		XOR3(out5,tmp3,in0);
		XOR4(out4,out1,out5,in4);
		XOR3(out7,out4,in2);
		XOR3(out6,tmp2,out7);
...
static void gf8_muladd_F2(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in4,in5);
		XOR4(out2,in2,in6,in7);
		XOR3(tmp1,tmp0,in1);
		XOR3(tmp2,tmp1,in2);
		XOR3(out0,tmp2,in3);
		XOR3(out3,tmp2,in7);
		XOR4(out5,out3,in0,in4);
		XOR3(tmp3,tmp0,out5);
		XOR3(out7,tmp3,in3);
		XOR3(out4,tmp3,out2);
		XOR4(out1,out0,out4,in4);
		XOR3(out6,tmp1,out1);
...
static void gf8_muladd_F6(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in0,in7);
		XOR3(out2,tmp0,in2);
		XOR4(out4,out2,in1,in4);
		XOR4(out7,out4,in3,in5);
		XOR4(out5,out7,in4,in7);
		XOR4(out0,tmp0,out7,in6);
		XOR3(tmp1,out0,in1);
		XOR4(out6,out0,in0,in5);
		XOR3(out3,tmp1,in3);
		XOR3(out1,tmp0,tmp1);
...
static void gf8_muladd_F8(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp2,tmp0,in6);
		XOR3(out4,tmp0,tmp1);
		XOR4(out1,tmp1,in2,in4);
		XOR3(out3,tmp2,in1);
		XOR3(out5,out3,in5);
		XOR4(out7,out1,out5,in7);
		XOR3(out6,tmp1,out7);
		XOR3(out0,tmp2,out7);
		XOR3(out2,out6,in0);
...
static void gf8_muladd_F9(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp4,tmp3,out3);
		XOR3(out1,tmp4,in5);
		XOR4(out0,tmp4,in0,in7);
		XOR4(out6,tmp0,out0,in4);
		XOR3(out7,tmp2,tmp4);
		XOR3(out2,tmp3,out6);
...
static void gf8_muladd_FA(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(out3,out6,in4);
		XOR3(out2,tmp1,out5);
		XOR4(out4,out2,out3,in1);
		XOR4(out0,out4,out7,in5);
		XOR3(out1,tmp2,out0);
...
static void gf8_muladd_FC(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp0,in1,in2);
		XOR3(tmp1,in0,in7);
		XOR4(out2,tmp0,tmp1,in5);
		XOR3(out3,tmp1,in4);
		XOR3(tmp2,out2,in6);
		XOR3(out6,tmp2,in4);
		XOR3(out7,tmp2,in3);
		XOR4(out4,out6,in1,in3);
		XOR3(tmp3,out4,in0);
		XOR3(out1,tmp3,in6);
		XOR4(out0,tmp3,in1,in5);
		XOR3(out5,tmp0,out4);
...
static void gf8_muladd_FD(uint8_t * out, uint8_t * in, unsigned int width)
{
	...
	for (i = 0; i < width; i++)
	{
		...
		XOR3(tmp1,in1,in7);
		XOR3(out2,tmp0,tmp1);
		XOR4(out6,out2,in2,in4);
		XOR3(tmp2,out6,in0);
		XOR3(out1,tmp2,in3);
		XOR4(out0,tmp0,out1,in6);
		XOR3(out5,out0,in2);
		XOR3(tmp3,out5,in1);
		XOR3(out3,tmp3,in6);
		XOR3(out7,tmp2,tmp3);
